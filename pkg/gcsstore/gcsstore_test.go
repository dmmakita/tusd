...
import (
	...
	"github.com/dmmakita/tusd/pkg/gcsstore"
	"github.com/dmmakita/tusd/pkg/handler"
)

// go:generate mockgen -destination=./gcsstore_mock_test.go -package=gcsstore_test github.com/dmmakita/tusd/pkg/gcsstore GCSReader,GCSAPI
